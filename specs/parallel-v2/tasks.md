...
- [ ] 1.1 Rewrite dispatch.md Step 7 for 1:1 TaskList tasks
...
- [ ] 1.2 Simplify task-completed-gate.sh for direct task ID extraction
...
- [ ] 1.3 Update teammate-prompt.md for 1:1 task references
...
- [ ] 1.4 Add completedGroups update to dispatch.md Step 8
...
- [ ] 1.5 Add stall/timeout handling to dispatch.md Step 8
...
- [ ] 1.6 Add phase metadata to verifyTasks in dispatch.md Step 6
...
- [ ] 1.7 Rewrite status.md Step 2 for TaskList-first progress
...
- [ ] 1.8 Clarify file-ownership vs worktree merge flow
...
- [ ] 1.9 Add dispatch --abort handler
...
- [ ] 1.10 Define partition rebalancing algorithm
...
- [ ] 1.11 Add optional file ownership enforcement guidance
...
- [ ] 1.12 Add --watch mode to status.md
...
- [ ] 1.13 Add end-to-end worked example to SKILL.md
...
- [ ] 2.1 Ensure dispatch.md internal consistency
...
- [ ] 2.2 Ensure cross-file consistency
...
- [ ] 3.2 Validate markdown structure
